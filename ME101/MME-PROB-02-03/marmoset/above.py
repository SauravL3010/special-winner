...
from time_of_flight import get_times, get_max_elevation
...
MAX_ELEVATION_INT = int(1000*get_max_elevation(LAUNCH_VELOCITY, LAUNCH_ANGLE))
ELEVATION_CHANGE = randint(1, MAX_ELEVATION_INT)/1000.0
...
print "Elevation change: " + str(ELEVATION_CHANGE) + "<br>"
...
if all_match :
    print "PASSED - Elevation is above launch point.<br>"
    sys.exit(0)
else :
    sys.exit(1)
