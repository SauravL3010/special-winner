...
even_number_1 = randint(1,100000)*2
...
cproc.stdin.write(str(even_number_1) + "\n")
time.sleep(0.1)
...
even_number_2 = randint(1,100000)*2
odd_number_2 = randint(1,100000)*2-1

cproc.stdin.write(str(even_number_2) + "\n")
time.sleep(0.1)
second_prompt = output_buffer_read.read()
...
if found_expected_number :
    print "PASSED - First entry is even."
    sys.exit(0)
else :
