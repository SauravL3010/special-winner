...
targets_file = open("targets.txt", "a")

coordinate_x = randint(10000, 99999) / 1000.0;
coordinate_y = randint(10000, 99999) / 1000.0;

targets_file.write("Mereen " + str(coordinate_x) + " " + str(coordinate_y) + "\n")
targets_file.close();
...
print "PASSED - Distances and headings calculated correctly."
sys.exit(0)
