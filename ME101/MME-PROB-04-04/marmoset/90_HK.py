...
pexpect_process.sendline("251")
pexpect_process.expect("(?i)enter")
pexpect_process.sendline("31")

print("Inputted values: $251 and 31 days")
print("Expected output: Hong Kong")
...
if found_list == [False, False, False, False, True] :
    print("PASSED")
    exit(0)
else :
    print("FAILED")
