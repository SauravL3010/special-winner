...
row_size = randint(1,20)
col_size = randint(1,50)
data_matrix = [[randint(1,100) for col in range(col_size)] for row in range(row_size)]

create_data_file = open("matrix_data.txt", "w")
create_data_file.write(str(row_size) + "\n")
create_data_file.write(str(col_size) + "\n")
