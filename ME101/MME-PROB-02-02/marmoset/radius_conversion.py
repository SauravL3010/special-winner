...
radius_1 = randint(1,100)
cproc.stdin.write(str(radius_1) + "\n")
time.sleep(0.1)
out = output_buffer_read.read()

radius_2 = randint(1, 100)
...
radius_conversions_match = True
if abs(out[0][0] - solutions_1[0])/solutions_1[0] > TOL_RELATIVE :
    radius_conversions_match = False
if abs(out[0][1] - solutions_2[0])/solutions_2[0] > TOL_RELATIVE :
    radius_conversions_match = False

if radius_conversions_match :
    print "PASSED - conversion from yards to meters."
    sys.exit(0)
else :
    print "FAILED - conversion from yards to meters.<br>"
    print "input 1: " + str(radius_1) + "<br>"
    print "solutions 1: " + str(solutions_1[0]) + "<br>"
    print "input 2: " + str(radius_2) + "<br>"
    print "solutions 2: " + str(solutions_2[0]) + "<br>"
    sys.exit(1)
