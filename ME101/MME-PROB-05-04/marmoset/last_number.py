...
if int(find_numbers[-1]) == ending_number :
    print "PASSED - Last number in sequence matches second input."
    sys.exit(0)
else :
    print "FAILED - Last number in sequence does not match second input."
    sys.exit(1)
